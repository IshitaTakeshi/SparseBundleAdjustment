def calcImgProj(a[5], Q[4], v[3], t[3], M[3]):  # Q -> qr0
    L = sqrt(1.0 - v[0] * v[0] - v[1] * v[1] - v[2] * v[2]);

    R[0] = L * Q[0] - v[0] * Q[1] - v[1] * Q[2] - v[2] * Q[3]
    R[1] = L * Q[1] + v[0] * Q[0] + v[1] * Q[3] - v[2] * Q[2]
    R[2] = L * Q[2] - v[0] * Q[3] + v[1] * Q[0] + v[2] * Q[1]
    R[3] = L * Q[3] + v[0] * Q[2] - v[1] * Q[1] + v[2] * Q[0]

    P[0] = + M[0] * R[0] - M[1] * R[3] + M[2] * R[2]
    P[1] = + M[0] * R[3] + M[1] * R[0] - M[2] * R[1]
    P[2] = - M[0] * R[2] + M[1] * R[1] + M[2] * R[0]
    P[3] = + M[0] * R[1] + M[1] * R[2] + M[2] * R[3]
